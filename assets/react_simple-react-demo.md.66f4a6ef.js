import{_ as s,c as n,o as a,a as l}from"./app.b8d11a0b.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"react/simple-react-demo.md"}'),p={name:"react/simple-react-demo.md"},e=l(`<ul><li>个人学习源码笔记</li><li>学习魔术师卡颂的 react 视频。代码大多与原作者一致，个人做了一些注释</li></ul><blockquote><p>个人笔记地址：<a href="https://github.com/huwuji/blog/tree/master/notes/FE-thinking" target="_blank" rel="noreferrer">https://github.com/huwuji/blog/tree/master/notes/FE-thinking</a></p></blockquote><p>直接上代码和解析</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">let isMount = true;</span></span>
